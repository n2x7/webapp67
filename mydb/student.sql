...
('', '0', '0', '0', 0),
('110', 'uraiwan na', 'inyam', 'pathumthani', 898944631),
...
CREATE TABLE `studentpet` (
  ...
  `sid` varchar(3) NOT NULL,
  `pid` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='student and pet informations';
